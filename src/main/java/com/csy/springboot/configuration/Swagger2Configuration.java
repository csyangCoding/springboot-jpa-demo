...
public class Swagger2Configuration {
    ...
    public Docket accessToken() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.csy.springboot.controller")) // 拦截的包路径
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()//
                ...
                .contact(new Contact("springboot demo", "http://127.0.0.1:8081/", "576388914@qq.com"))// 联系
                .version("1.0")// 版本
                .build();
    }
}
